...
% TODO: Put color bars in the rogues plots?
...
\begin{figure}
    ...
    \caption{
        Ly$\alpha$ luminosity for a median line of sight for each galaxy in our sample (lines), with observational data from Table~\ref{table:labs} overplotted as points.
...
As we have discussed previously in this work, the {\it escaping} Ly$\alpha$ luminosity, and variations in this escape fraction can be sufficient to confound simplistic reasoning about the powering source of blobs.
